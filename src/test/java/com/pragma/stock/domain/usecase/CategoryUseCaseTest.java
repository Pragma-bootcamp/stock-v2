...
class CategoryUseCaseTest {
    ...
    void saveBrandExceptionShortName() {
        ...
        assertEquals(CategoryConstant.CATEGORY_NAME_LENGTH_MESSAGE, exception.getErrorMessage());
    ...
    void saveBrandExceptionEmptyName() {
        ...
        category.setName("");
        CategoryException exception = assertThrows(CategoryException.class, () -> categoryUseCase.saveCategory(category));
        assertEquals(CategoryConstant.CATEGORY_FIELD_NAME_NOT_EMPTY, exception.getErrorMessage());
    ...
    void saveBrandExceptionNullName() {
        ...
        CategoryException exception = assertThrows(CategoryException.class, () -> categoryUseCase.saveCategory(category));
        assertEquals(CategoryConstant.CATEGORY_FIELD_NAME_NOT_NULL, exception.getErrorMessage());
        assertEquals(HttpStatus.BAD_REQUEST.value(), exception.getErrorCode());
    }
    ...
    void saveBrandExceptionShortDescription() {
        ...
        category.setName(Constant.DEFAULT_NAME);
        CategoryException exception = assertThrows(CategoryException.class, () -> categoryUseCase.saveCategory(category));
        assertEquals(CategoryConstant.CATEGORY_DESCRIPTION_LENGTH_MESSAGE, exception.getErrorMessage());
        assertEquals(ErrorCodeConstant.BAD_REQUEST, exception.getErrorCode());
    }
    ...
    void saveBrandExceptionEmptyDescription() {
        ...
        category.setName(Constant.DEFAULT_NAME);
        CategoryException exception = assertThrows(CategoryException.class, () -> categoryUseCase.saveCategory(category));
        assertEquals(CategoryConstant.CATEGORY_FIELD_DESCRIPTION_NOT_EMPTY, exception.getErrorMessage());
        assertEquals(ErrorCodeConstant.BAD_REQUEST, exception.getErrorCode());
    }
    ...
    void saveBrandExceptionNullDescription() {
        ...
        category.setName(Constant.DEFAULT_NAME);
        CategoryException exception = assertThrows(CategoryException.class, () -> categoryUseCase.saveCategory(category));
        assertEquals(CategoryConstant.CATEGORY_FIELD_DESCRIPTION_NOT_NULL, exception.getErrorMessage());
        assertEquals(ErrorCodeConstant.BAD_REQUEST, exception.getErrorCode());
    }
